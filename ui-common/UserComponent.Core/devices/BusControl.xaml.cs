...
{
    /// <summary>
    /// BusControl.xaml 的交互逻辑
    /// </summary>
    public partial class BusControl : UserControl
    {
        #region Properties

        private static readonly Type ControlType = typeof(BusControl);
        ...
        {
            (DataContext as BusViewModel)?.Dispose();
        }
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                throw new ArgumentNullException($"Device:[{DeviceId}] - StationId is empty.");
            }
            ...
            if (DataContext == null || DataContext is not BusViewModel)
            {
                var vm = new BusViewModel(StationId, DeviceId)
                {
